        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Damages</h1>
                <p className="text-sm text-gray-600">Track vehicle damages</p>
              </div>
            </div>
            <button
              onClick={() => {
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8">
            ...
            <Link href="/dashboard/damages" className="border-b-2 border-blue-600 py-4 px-1 text-sm font-medium text-blue-600">
              Damages
            </Link>
          </div>
        </div>
